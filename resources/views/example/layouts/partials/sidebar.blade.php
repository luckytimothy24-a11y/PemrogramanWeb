    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
        <ul class="pb-2 space-y-1">
          <li>
            <a href="{{ route('dashboard.stock') }}" class="flex items-center p-2 text-base rounded-lg transition duration-75 {{ request()->routeIs('dashboard.stock') ? 'bg-blue-50 text-blue-700 dark:bg-gray-700 dark:text-white' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700' }}">
          ...
          <li>
            <a href="{{ route('categories.index') }}" class="flex items-center p-2 text-base rounded-lg transition duration-75 {{ request()->routeIs('categories.index') ? 'bg-blue-50 text-blue-700 dark:bg-gray-700 dark:text-white' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700' }}">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 4a1 1 0 011-1h3a1 1 0 011 1v2h8a1 1 0 011 1v2H4a1 1 0 01-1-1V4zm2 4h10v7a1 1 0 01-1 1H6a1 1 0 01-1-1V8z"></path></svg>
              <span class="ml-3">Kategori</span>
            </a>
          </li>
          <li>
            <a href="{{ route('products.index') }}" class="flex items-center p-2 text-base rounded-lg transition duration-75 {{ request()->routeIs('products.index') ? 'bg-blue-50 text-blue-700 dark:bg-gray-700 dark:text-white' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700' }}">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm0 2h12v2H4V6zm0 4h7v4H4v-4zm9 0h3v4h-3v-4z"></path></svg>
              <span class="ml-3">Produk</span>
            </a>
          </li>
          <li>
            <a href="{{ route('suppliers.index') }}" class="flex items-center p-2 text-base rounded-lg transition duration-75 {{ request()->routeIs('suppliers.index') ? 'bg-blue-50 text-blue-700 dark:bg-gray-700 dark:text-white' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700' }}">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 4a2 2 0 00-2 2v8a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2H5zm1 3h8v2H6V7zm0 4h5v2H6v-2z"></path></svg>
              <span class="ml-3">Supplier</span>
            </a>
          </li>
          <li>
            <a href="{{ route('stock.index') }}" class="flex items-center p-2 text-base rounded-lg transition duration-75 {{ request()->routeIs('stock.index') ? 'bg-blue-50 text-blue-700 dark:bg-gray-700 dark:text-white' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700' }}">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 3a1 1 0 011-1h12a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1V3zm2 2v2h10V5H5zm-2 5a1 1 0 011-1h12a1 1 0 011 1v4a1 1 0 01-1 1H4a1 1 0 01-1-1v-4zm2 2v2h10v-2H5z"></path></svg>
              <span class="ml-3">Stok</span>
            </a>
          </li>
          <li>
            <a href="{{ url('example/settings') }}" class="flex items-center p-2 text-base rounded-lg transition duration-75 {{ $page_slug == 'settings' ? 'bg-blue-50 text-blue-700 dark:bg-gray-700 dark:text-white' : 'text-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700' }}">
