...
<div class="mx-auto max-w-4xl">
    <div class="mb-6">
        ...
        <h1 class="mt-1 text-2xl font-bold text-gray-900 dark:text-white">Ubah Produk</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi produk berikut.</p>
    </div>
